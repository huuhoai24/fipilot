...
- Use CandidateProfile evidence, especially skill_evidence, projects, and experiences matching the round topic.
...
- DYNAMIC & VARIED QUESTIONING: Explore varied technical angles (e.g., architecture decisions, edge case handling, performance optimization, debugging complex bugs, latency vs accuracy trade-offs, system integration) rather than repeating standard question templates.
- Ground the question in concrete candidate evidence and ask about mechanisms, decisions, trade-offs, measurements, debugging, or failure cases.

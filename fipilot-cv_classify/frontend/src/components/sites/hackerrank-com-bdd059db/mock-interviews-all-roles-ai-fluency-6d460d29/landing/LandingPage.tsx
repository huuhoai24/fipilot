...
export function LandingPage() {
  ...
  const [setupStep, setSetupStep] = useState<"resume" | "experience" | "device" | null>(null);
    ...
    <div className={styles.root}>
      ...
      {setupStep === "experience" ? (
        <InterviewExperienceDialog
          ...
          profile={JSON.parse(sessionStorage.getItem(RESUME_PROFILE_STORAGE_KEY) ?? "{}") as ResumeProfile}
        />
      ) : null}
      {setupStep === "resume" ? (
        <ResumeUploadStep
      ...
      {setupStep === "device" ? (
        <DeviceSettingsDialog onBack={() => setSetupStep("experience")} onStart={startInterview} />
      ) : null}
    </div>
  );
}

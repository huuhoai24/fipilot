...
export function ResumeUploadStep({ onBack, onContinue, onFileChange }: ResumeUploadStepProps) {
  ...
  return (
    <div className={styles.dialogBackdrop}>
      ...
      <section
        className={`${styles.wizardDialog} ${styles.resumeDialog} ${phase === "success" ? styles.resumeReviewDialog : ""}`}
        role="dialog"
        aria-modal="true"
      ...
      >
        <div className={styles.wizardContent}>
          ...
          {phase === "success" && resumeFilename !== null && resumeResult !== null ? (
            <div className={styles.resumeReview}>
              <div className={styles.resumeSuccessIntro}>
                <strong>Your resume has been analyzed</strong>
                <p>Review the extracted information before starting your interview.</p>
              </div>
              ...
              <ResumeExtractionReview profile={resumeResult.profile} />
            </div>
          ) : (
            <div
          ...
          <footer className={`${styles.wizardFooter} ${styles.resumeFooter}`}>
            ...
            <button
              ...
              disabled={
                phase !== "success"
                || resumeResult === null
                || !summarizeResumeExtraction(resumeResult.profile).canContinue
              }
              onClick={onContinue}
              type="button"
            >

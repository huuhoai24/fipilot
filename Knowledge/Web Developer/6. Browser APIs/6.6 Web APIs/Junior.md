...
- Explain how Notifications API affects user interaction, browser state, networking, or background work.
...
- Evaluate whether Notifications API is suitable for a defined user experience.

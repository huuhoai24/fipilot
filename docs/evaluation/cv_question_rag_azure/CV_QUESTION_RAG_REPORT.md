...
- Question cases: 150 holdout cases using Azure OpenAI Question Generator (GPT-4.1-mini) plus a separate LLM-as-judge pass.
...
- MRR@8: 0.9564
- Latency mean/P95: 8.49 / 13.25 ms
...
- Mean clarity: 4.8467 / 5
- Mean specificity: 2.0000 / 2
- Mean retrieval grounding: 2.0000 / 2
- Deterministic grounding overlap: 0.3073
- Retrieval utilization rate: 0.9400
- Target-topic mention rate: 0.7333
- Language match rate: 1.0000
- Difficulty-label exact match: 1.0000
- Normalized exact duplicate rate: 0.0000
- Opening-phrase repetition rate: 0.9133
- Unsupported experience-assumption rate: 0.6067
- False-premise rate: 0.0000
- Pattern audit counts: 0 exact-duplicate excess, 137 repeated-opening excess, 91 unsupported-experience flags.

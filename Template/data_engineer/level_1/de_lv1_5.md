...
### Câu 5
* **Độ khó:** Trung bình
* **Câu hỏi:** Trong công nghệ xử lý dữ liệu phân tán Apache Spark, hai khái niệm "Driver" and "Executor" đóng vai trò logic gì trong kiến trúc vận hành của một ứng dụng (Application)?
* **expected_key_points:**
  - id: KP5_1

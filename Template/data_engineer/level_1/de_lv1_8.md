...
### Câu 2
* **Độ khó:** Dễ
* **Câu hỏi:** Khi xây dựng Data Lake, hãy phân biệt điểm khác biệt cốt lõi về cấu trúc lưu trữ và tối ưu hóa hiệu năng đọc/ghi giữa hai định dạng tệp tin: CSV (văn bản thô) và Apache Parquet (nhị phân).
* **expected_key_points:**
  - id: KP2_1
...
* **expected_key_points:**
  ...
  - id: KP10_2
    ...
    keypoint_weight: 0.3
    description: Watermark là một mốc thời gian logic di chuyển tịnh tiến đại diện cho tiến trình của Event Time. Nó đóng vai trò là một lời khẳng định ngầm rằng "hệ thống giả định không còn dữ liệu nào có Event Time cũ hơn mốc $T$ này xuất hiện nữa", làm căn cứ để quản lý cửa sổ thời gian (Windowing).
  - id: KP10_3

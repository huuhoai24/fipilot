...
* **expected_key_points:**
  - id: KP10_1
    ...
    keypoint_weight: 0.4
    description: - **Event Time:** Thời điểm sự kiện thực sự xảy ra ở thiết bị nguồn (được ghi nhận trong payload dữ liệu).
                 - **Ingestion Time:** Thời điểm sự kiện được nạp vào hệ thống tiếp nhận (như Kafka topic).
                 - **Processing Time:** Thời điểm sự kiện được luồng tính toán (như Spark/Flink) thực thi xử lý trực tiếp trên RAM.
  - id: KP10_2

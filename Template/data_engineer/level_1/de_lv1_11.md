...
* **expected_key_points:**
  - id: KP1_1
    ...
    keypoint_weight: 0.5
    description: Full Backup sao chép toàn bộ dữ liệu hiện có trong hệ thống tại một mốc thời gian. Kỹ thuật này an toàn, dễ khôi phục nhất nhưng tiêu tốn rất nhiều không gian lưu trữ và thời gian thực thi, nên thường được chạy định kỳ với tần suất thấp (ví dụ: hàng tuần).
  - id: KP1_2
...
* **expected_key_points:**
  - id: KP2_1
    ...
    keypoint_weight: 0.5
    description: Message Queue đóng vai trò làm vùng đệm lưu trữ tạm thời tách biệt hoàn toàn hệ thống tạo dữ liệu (Producer) và hệ thống tiêu thụ dữ liệu (Consumer). Giúp hai hệ thống hoạt động độc lập phi đồng bộ, không phụ thuộc trực tiếp vào nhau.
  - id: KP2_2
...
### Câu 5
* **Độ khó:** Trung bình
* **Câu hỏi:** Trong thiết kế cơ sở dữ liệu phân tích (OLAP), kỹ thuật thiết kế bảng "Partitioning" (Phân vùng) và "Clustering" (Gom cụm) khác nhau như thế nào về cơ chế tổ chức dữ liệu vật lý và cách tối ưu câu lệnh truy vấn?
* **expected_key_points:**
  - id: KP5_1

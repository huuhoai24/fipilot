# Bộ Câu Hỏi Phỏng Vấn Business Analyst (Level 3)
...
### Câu 1
* **Độ khó:** Dễ
* **Câu hỏi:** Trước khi dẫn dắt xây dựng một bộ yêu cầu đã được xác thực, bạn thường đánh giá những rủi ro kiến trúc nào?
...
### Câu 2
* **Độ khó:** Dễ
* **Câu hỏi:** Bạn mentor một teammate ít kinh nghiệm hơn đang làm về phân tích yêu cầu, giao tiếp stakeholder, process mapping và user story như thế nào?
...
### Câu 3
* **Độ khó:** Dễ
* **Câu hỏi:** Dấu hiệu nào cho thấy một solution trong hệ BRD, SRS, BPMN, user story, acceptance criteria, Jira đang trở nên khó bảo trì?
...
### Câu 4
* **Độ khó:** Trung bình
* **Câu hỏi:** Hãy thiết kế high-level approach để scale một bộ yêu cầu đã được xác thực khi usage tăng 10 lần.
...
### Câu 6
* **Độ khó:** Trung bình
* **Câu hỏi:** Bạn định nghĩa success metrics cho một dự án liên quan tới phân tích yêu cầu, giao tiếp stakeholder, process mapping và user story như thế nào?
...
### Câu 7
* **Độ khó:** Trung bình
* **Câu hỏi:** Khi thiết kế một bộ yêu cầu đã được xác thực, bạn tiếp cận security và privacy như thế nào?
...
### Câu 8
* **Độ khó:** Khó
* **Câu hỏi:** Hai senior engineer bất đồng hướng thiết kế cho một bộ yêu cầu đã được xác thực. Bạn sẽ dẫn dắt việc ra quyết định thế nào?
...
### Câu 9
* **Độ khó:** Khó
* **Câu hỏi:** Bạn xử lý một legacy system liên quan tới phân tích yêu cầu, giao tiếp stakeholder, process mapping và user story vừa business-critical vừa rủi ro khi sửa như thế nào?
...
### Câu 10
* **Độ khó:** Khó
* **Câu hỏi:** Bạn chuẩn bị một bộ yêu cầu đã được xác thực để một team khác có thể ownership lâu dài như thế nào?

...
* **expected_key_points:**
  - id: KP1_1
    ...
    keypoint_weight: 0.5
    description: Là những mục tiêu, tầm nhìn chiến lược ở cấp độ tổ chức hoặc doanh nghiệp, giải thích lý do tại sao dự án được khởi tạo và lợi ích kinh doanh mong muốn đạt được (ví dụ: tăng trưởng doanh thu, tối ưu hóa quy trình vận hành).
  - id: KP1_2

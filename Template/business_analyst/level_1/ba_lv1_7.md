...
* **expected_key_points:**
  - id: KP1_1
    ...
    keypoint_weight: 0.5
    description: Là những mục tiêu, tầm nhìn chiến lược ở cấp độ tổ chức hoặc doanh nghiệp, giải thích lý do tại sao dự án được khởi tạo và lợi ích kinh doanh mong muốn đạt được (ví dụ: tăng 20% doanh thu, tối ưu hóa quy trình vận hành).
  - id: KP1_2
...
* **expected_key_points:**
  ...
  - id: KP7_2
    ...
    keypoint_weight: 0.5
    description: BA chịu trách nhiệm thiết lập bộ kịch bản kiểm thử nghiệm thu (UAT Test Scenarios), hướng dẫn và hỗ trợ người dùng thực hiện test, thu thập và phân loại các phản hồi về lỗi phát sinh hoặc yêu cầu thay đổi (Change Requests) để chuyển giao về cho đội phát triển.

# Bộ Câu Hỏi Phỏng Vấn Database Administrator (Level 1)
...
### Câu 1
* **Độ khó:** Dễ
* **Câu hỏi:** Theo bạn, trách nhiệm chính của một Database Administrator trong team phần mềm là gì?
* **Đáp án mẫu:** Câu trả lời tốt nên nêu được việc hiểu yêu cầu được giao, đóng góp vào một môi trường database ổn định, làm việc cẩn thận, báo sớm blocker, tuân thủ tiêu chuẩn của team và có tinh thần học hỏi.

### Câu 2
* **Độ khó:** Dễ
* **Câu hỏi:** Bạn đã từng dùng công cụ hoặc công nghệ nào trong nhóm sau: PostgreSQL, MySQL, SQL Server, index, replication, backup/restore?
...
### Câu 3
* **Độ khó:** Dễ
* **Câu hỏi:** Trước khi bàn giao một môi trường database ổn định, bạn kiểm tra công việc của mình như thế nào?
...
### Câu 4
* **Độ khó:** Trung bình
* **Câu hỏi:** Hãy kể một bug hoặc vấn đề bạn từng gặp khi làm việc với vận hành database, backup, replication, query tuning và availability. Bạn đã điều tra như thế nào?
...
### Câu 6
* **Độ khó:** Trung bình
* **Câu hỏi:** Trong công việc Database Administrator, khác nhau giữa cách vá tạm và cách sửa đúng gốc là gì?

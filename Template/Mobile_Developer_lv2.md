# Bộ Câu Hỏi Phỏng Vấn Mobile Developer (Level 2)
...
### Câu 1
* **Độ khó:** Dễ
* **Câu hỏi:** Khi nhận một task Mobile Developer cỡ vừa, bạn chia nhỏ công việc trước khi implement như thế nào?
...
### Câu 2
* **Độ khó:** Dễ
* **Câu hỏi:** Với một tính năng ứng dụng mobile, bạn sẽ thêm những quality check nào trước khi đưa vào production?
...
### Câu 3
* **Độ khó:** Dễ
* **Câu hỏi:** Theo bạn phần nào trong UI mobile, navigation, offline handling, hiệu năng app và tích hợp API dễ phát sinh lỗi nhất, và bạn giảm lỗi bằng cách nào?
...
### Câu 6
* **Độ khó:** Trung bình
* **Câu hỏi:** Bạn sẽ thiết kế error handling cho một tính năng ứng dụng mobile như thế nào?
...
### Câu 7
* **Độ khó:** Trung bình
* **Câu hỏi:** Khi review công việc của teammate liên quan tới UI mobile, navigation, offline handling, hiệu năng app và tích hợp API, bạn tập trung vào điểm gì?
...
### Câu 8
* **Độ khó:** Khó
* **Câu hỏi:** Một sự cố production xuất hiện sau release liên quan tới một tính năng ứng dụng mobile. Bạn sẽ xử lý incident như thế nào?
...
### Câu 9
* **Độ khó:** Khó
* **Câu hỏi:** Bạn cân bằng tốc độ delivery và technical debt trong dự án dùng Android, iOS, React Native, Flutter, SQLite, push notification như thế nào?

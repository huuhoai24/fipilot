# Bộ Câu Hỏi Phỏng Vấn Data Scientist (Level 2)
...
### Câu 1
* **Độ khó:** Dễ
* **Câu hỏi:** Khi nhận một task Data Scientist cỡ vừa, bạn chia nhỏ công việc trước khi implement như thế nào?
...
### Câu 2
* **Độ khó:** Dễ
* **Câu hỏi:** Với một dự án phân tích dự đoán, bạn sẽ thêm những quality check nào trước khi đưa vào production?
...
### Câu 3
* **Độ khó:** Dễ
* **Câu hỏi:** Theo bạn phần nào trong phân tích thống kê, feature engineering, đánh giá mô hình và experimentation dễ phát sinh lỗi nhất, và bạn giảm lỗi bằng cách nào?
...
### Câu 6
* **Độ khó:** Trung bình
* **Câu hỏi:** Bạn sẽ thiết kế error handling cho một dự án phân tích dự đoán như thế nào?
...
### Câu 7
* **Độ khó:** Trung bình
* **Câu hỏi:** Khi review công việc của teammate liên quan tới phân tích thống kê, feature engineering, đánh giá mô hình và experimentation, bạn tập trung vào điểm gì?
...
### Câu 8
* **Độ khó:** Khó
* **Câu hỏi:** Một sự cố production xuất hiện sau release liên quan tới một dự án phân tích dự đoán. Bạn sẽ xử lý incident như thế nào?
...
### Câu 9
* **Độ khó:** Khó
* **Câu hỏi:** Bạn cân bằng tốc độ delivery và technical debt trong dự án dùng Python, Pandas, scikit-learn, SQL, notebook, visualization như thế nào?

# Bộ Câu Hỏi Phỏng Vấn Data Scientist (Level 3)
...
### Câu 1
* **Độ khó:** Dễ
* **Câu hỏi:** Trước khi dẫn dắt xây dựng một dự án phân tích dự đoán, bạn thường đánh giá những rủi ro kiến trúc nào?
...
### Câu 2
* **Độ khó:** Dễ
* **Câu hỏi:** Bạn mentor một teammate ít kinh nghiệm hơn đang làm về phân tích thống kê, feature engineering, đánh giá mô hình và experimentation như thế nào?
...
### Câu 3
* **Độ khó:** Dễ
* **Câu hỏi:** Dấu hiệu nào cho thấy một solution trong hệ Python, Pandas, scikit-learn, SQL, notebook, visualization đang trở nên khó bảo trì?
...
### Câu 4
* **Độ khó:** Trung bình
* **Câu hỏi:** Hãy thiết kế high-level approach để scale một dự án phân tích dự đoán khi usage tăng 10 lần.
...
### Câu 6
* **Độ khó:** Trung bình
* **Câu hỏi:** Bạn định nghĩa success metrics cho một dự án liên quan tới phân tích thống kê, feature engineering, đánh giá mô hình và experimentation như thế nào?
...
### Câu 7
* **Độ khó:** Trung bình
* **Câu hỏi:** Khi thiết kế một dự án phân tích dự đoán, bạn tiếp cận security và privacy như thế nào?
...
### Câu 8
* **Độ khó:** Khó
* **Câu hỏi:** Hai senior engineer bất đồng hướng thiết kế cho một dự án phân tích dự đoán. Bạn sẽ dẫn dắt việc ra quyết định thế nào?
...
### Câu 9
* **Độ khó:** Khó
* **Câu hỏi:** Bạn xử lý một legacy system liên quan tới phân tích thống kê, feature engineering, đánh giá mô hình và experimentation vừa business-critical vừa rủi ro khi sửa như thế nào?
...
### Câu 10
* **Độ khó:** Khó
* **Câu hỏi:** Bạn chuẩn bị một dự án phân tích dự đoán để một team khác có thể ownership lâu dài như thế nào?

# Bộ Câu Hỏi Phỏng Vấn Cloud Engineer (Level 2)
...
### Câu 1
* **Độ khó:** Dễ
* **Câu hỏi:** Khi nhận một task Cloud Engineer cỡ vừa, bạn chia nhỏ công việc trước khi implement như thế nào?
...
### Câu 2
* **Độ khó:** Dễ
* **Câu hỏi:** Với một dịch vụ cloud có khả năng mở rộng, bạn sẽ thêm những quality check nào trước khi đưa vào production?
...
### Câu 3
* **Độ khó:** Dễ
* **Câu hỏi:** Theo bạn phần nào trong hạ tầng cloud, networking, IAM, scalability, observability và kiểm soát chi phí dễ phát sinh lỗi nhất, và bạn giảm lỗi bằng cách nào?
...
### Câu 6
* **Độ khó:** Trung bình
* **Câu hỏi:** Bạn sẽ thiết kế error handling cho một dịch vụ cloud có khả năng mở rộng như thế nào?
...
### Câu 7
* **Độ khó:** Trung bình
* **Câu hỏi:** Khi review công việc của teammate liên quan tới hạ tầng cloud, networking, IAM, scalability, observability và kiểm soát chi phí, bạn tập trung vào điểm gì?
...
### Câu 8
* **Độ khó:** Khó
* **Câu hỏi:** Một sự cố production xuất hiện sau release liên quan tới một dịch vụ cloud có khả năng mở rộng. Bạn sẽ xử lý incident như thế nào?
...
### Câu 9
* **Độ khó:** Khó
* **Câu hỏi:** Bạn cân bằng tốc độ delivery và technical debt trong dự án dùng AWS, Azure, GCP, VPC, IAM, load balancer, autoscaling như thế nào?

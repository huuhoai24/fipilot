...
* **expected_key_points:**
  - id: KP1_1
    content: Bản chất của GET và POST
    keypoint_weight: 0.6
...
### Câu 8
* **Độ khó:** Khó
* **Câu hỏi:** Explain the concept of RESTful API. What are the key constraints to make an API truly RESTful?
* **expected_key_points:**
  - id: KP8_1
...
* **expected_key_points:**
  ...
  - id: KP9_2
    ...
    keypoint_weight: 0.3
    description: Code splitting, tree shaking, sử dụng virtual DOM (đối với React), tránh re-render không cần thiết.
  - id: KP9_3
    content: Caching
    keypoint_weight: 0.3

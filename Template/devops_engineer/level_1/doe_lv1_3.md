...
### Câu 1
* **Độ khó:** Dễ
* **Câu hỏi:** Trong quy trình CI/CD và quản lý vòng đời ứng dụng, hãy giải thích sự khác biệt cơ bản về mặt cơ chế và ảnh hưởng đến Git History giữa hai thao tác: `git merge` và `git rebase`.
* **expected_key_points:**
  - id: KP1_1
...
* **expected_key_points:**
  ...
  - id: KP7_3
    content: Cơ chế Inject Secret động vào runtime biến môi trường (Environment Variables)
    keypoint_weight: 0.2

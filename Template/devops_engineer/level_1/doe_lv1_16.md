...
### Câu 1
* **Độ khó:** Dễ
* **Câu hỏi:** Trong quy trình CI/CD, hãy giải thích sự khác biệt cơ bản giữa Continuous Integration (CI) và Continuous Delivery (CD).
* **expected_key_points:**
  - id: KP1_1
...
* **expected_key_points:**
  ...
  - id: KP6_2
    ...
    keypoint_weight: 0.5
    description: Với mô hình Pull, nếu không kết nối được đến target, hệ thống có thể ngay lập tức đánh dấu target đó là "DOWN", trong khi mô hình Push khó phân biệt giữa việc ứng dụng chết hay mạng bị nghẽn.

# Bộ Câu Hỏi Phỏng Vấn Backend Developer (Level 5) - Tập Đề Observability và PII Masking (19)
...
### Câu 6
* **Độ khó:** Trung bình
* **Câu hỏi:** Phân tích cơ chế hoạt động của Distributed Tracing trong môi trường xử lý không đồng bộ (Asynchronous/Event-driven) sử dụng Kafka và các workers xử lý chạy ngầm.
* **expected_key_points:**
  - id: KP6_1

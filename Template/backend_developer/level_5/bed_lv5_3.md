# Bộ Câu Hỏi Phỏng Vấn Backend Developer (Level 5) - Tập Đề Apache Kafka và Event-Driven Architecture (3)
...
### Câu 10
* **Độ khó:** Khó
* **Câu hỏi:** Thiết kế kiến trúc Event Broker phân tán đa vùng địa lý (Multi-datacenter Kafka) đảm bảo đồng bộ hóa dữ liệu với độ trễ thấp và không làm mất mát tin nhắn (No data loss) khi xảy ra thảm họa đứt kết nối mạng liên lục địa.
* **expected_key_points:**
  - id: KP10_1

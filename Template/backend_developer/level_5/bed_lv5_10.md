# Bộ Câu Hỏi Phỏng Vấn Backend Developer (Level 5) - Tập Đề Kubernetes Infrastructure và CI/CD GitOps (10)
...
* **expected_key_points:**
  ...
  - id: KP8_2
    content: Tự động Failover an toàn (Split-brain prevention)
    keypoint_weight: 0.5

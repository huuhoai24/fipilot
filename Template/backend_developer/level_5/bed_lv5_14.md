# Bộ Câu Hỏi Phỏng Vấn Backend Developer (Level 5) - Tập Đề Caching Patterns và Redlock (14)
...
### Câu 1
* **Độ khó:** Dễ
* **Câu hỏi:** So sánh Cache-Aside pattern và Read/Write-Through pattern.
* **expected_key_points:**
  - id: KP1_1
...
### Câu 2
* **Độ khó:** Dễ
* **Câu hỏi:** Cache Penetration và cách ngăn chặn dùng Bloom Filter.
* **expected_key_points:**
  - id: KP2_1
...
### Câu 3
* **Độ khó:** Dễ
* **Câu hỏi:** So sánh khóa phân tán bằng Redis (Redlock) và ZooKeeper.
* **expected_key_points:**
  - id: KP3_1
...
### Câu 4
* **Độ khó:** Trung bình
* **Câu hỏi:** Các chiến lược Eviction Policies của Redis (LRU, LFU) và áp dụng.
* **expected_key_points:**
  - id: KP4_1
...
### Câu 5
* **Độ khó:** Trung bình
* **Câu hỏi:** Thiết kế giải pháp đồng bộ cache và DB chống Stale Cache.
* **expected_key_points:**
  - id: KP5_1
...
### Câu 6
* **Độ khó:** Trung bình
* **Câu hỏi:** Khắc phục Cache Avalanche và Cache Stampede bằng XFetch.
* **expected_key_points:**
  - id: KP6_1
...
### Câu 7
* **Độ khó:** Trung bình
* **Câu hỏi:** Nguyên lý hoạt động của thuật toán Redlock trên cụm multi-master Redis.
* **expected_key_points:**
  - id: KP7_1
...
### Câu 8
* **Độ khó:** Khó
* **Câu hỏi:** Thiết kế hệ thống khóa phân tán triệu rps an toàn trước lỗi mạng.
* **expected_key_points:**
  - id: KP8_1
...
### Câu 9
* **Độ khó:** Khó
* **Câu hỏi:** Thiết kế hệ thống Cache đa tầng (L1 Caffeine + L2 Redis Cluster) đồng bộ thời gian thực.
* **expected_key_points:**
  - id: KP9_1
...
### Câu 10
* **Độ khó:** Khó
* **Câu hỏi:** Thiết kế hệ thống cấu hình động (Configuration Management System) dùng etcd Watcher.
* **expected_key_points:**
  - id: KP10_1

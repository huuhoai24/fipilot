# Bộ Câu Hỏi Phỏng Vấn Backend Developer (Level 5) - Tập Đề Disaster Recovery và Multi-Region active-active (7)
...
* **expected_key_points:**
  ...
  - id: KP6_2
    ...
    keypoint_weight: 0.5
    description: Cấu hình CDN trả về dữ liệu cache cũ (stale cache) cho người dùng thay vì báo lỗi khi server gốc không phản hồi, duy trì trải nghiệm đọc tối thiểu của user.

# Bộ Câu Hỏi Phỏng Vấn Backend Developer (Level 4) - Tập Đề Distributed Consensus và Leader Leases (11)
...
### Câu 7
* **Độ khó:** Trung bình
* **Câu hỏi:** Giải thích cấu trúc và nguyên lý hoạt động của cơ chế Raft Leader Leases nhằm tối ưu hóa hiệu năng đọc dữ liệu nhất quán.
* **expected_key_points:**
  - id: KP7_1
    content: Vấn đề đọc thông thường trên Raft
    keypoint_weight: 0.5

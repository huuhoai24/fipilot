# Bộ Câu Hỏi Phỏng Vấn AI Engineer (Level 5) - Tập Đề Deep RL và Sim-to-Real Robots (8)
...
* **expected_key_points:**
  - id: KP5_1
    ...
    keypoint_weight: 0.5
    description: DDPG trực tiếp đầu ra một hành động cụ thể $a = \mu_\theta(s)$ thay vị phân phối xác suất. Sử dụng mạng Critic để ước lượng giá trị $Q(s, a)$ và cập nhật mạng Actor bằng cách tăng giá trị Q này.
  - id: KP5_2
...
### Câu 10
* **Độ khó:** Khó
* **Câu hỏi:** Thiết kế hệ thống giao dịch chứng khoán phái sinh tự động (Algorithmic Trading Agent) sử dụng học tăng cường sâu để tối đa hóa lợi nhuận và quản lý rủi ro sụt giảm tài sản (Drawdown).
* **expected_key_points:**
  - id: KP10_1

# Bộ Câu Hỏi Phỏng Vấn AI Engineer (Level 5) - Tập Đề Computer Vision và stable Diffusion (15)
...
### Câu 8
* **Độ khó:** Khó
* **Câu hỏi:** Thiết hệ thống camera giám sát an ninh tự động phát hiện hành vi trộm cắp tại siêu thị thời gian thực sử dụng các kỹ thuật nhận diện hành động (Action Recognition) từ luồng video.
* **expected_key_points:**
  - id: KP8_1

# Bộ Câu Hỏi Phỏng Vấn AI Engineer (Level 2) - Tập Đề DeepSORT và Object Tracking (15)
...
* **expected_key_points:**
  - id: KP3_1
    ...
    keypoint_weight: 0.6
    description: Mixup hòa trộn tuyến tính hai ảnh ngẫu nhiên và nhãn tương ứng theo tỷ lệ $\lambda$. CutMix cắt một vùng của ảnh A đè lên ảnh B và trộn nhãn theo tỷ lệ diện tích.
  - id: KP3_2

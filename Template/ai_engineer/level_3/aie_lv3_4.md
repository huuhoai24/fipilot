# Bộ Câu Hỏi Phỏng Vấn AI Engineer (Level 3) - Tập Đề Time Series và Demand Forecasting (4)
...
* **expected_key_points:**
  ...
  - id: KP2_2
    ...
    keypoint_weight: 0.5
    description: sMAPE tính phần trăm sai số đối xứng, giúp dễ so sánh giữa các chuỗi có quy mô khác nhau, nhưng bị mất ổn định khi giá trị thực tế/dự báo gần bằng 0.
...
### Câu 7
* **Độ khó:** Trung bình
* **Câu hỏi:** Làm thế nào để xử lý bài toán dự báo nhu cầu sản phẩm (Demand Forecasting) khi gặp hiện tượng chuỗi thời gian thưa (Intermittent Demand - sản phẩm bán ngẫu nhiên, phần lớn thời gian doanh số bằng 0)?
* **expected_key_points:**
  - id: KP7_1

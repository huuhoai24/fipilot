# Bộ Câu Hỏi Phỏng Vấn AI Engineer (Level 3) - Tập Đề Advanced NLP và Knowledge Graphs (18)
...
### Câu 5
* **Độ khó:** Trung bình
* **Câu hỏi:** Thiết kế pipeline tự động trích xuất thông tin (Information Extraction) dạng Tri thức (Entities & Relations) từ văn bản tiếng Việt phi cấu trúc sử dụng LLM.
* **expected_key_points:**
  - id: KP5_1

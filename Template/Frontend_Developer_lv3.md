# Bộ Câu Hỏi Phỏng Vấn Frontend Developer (Level 3)
...
### Câu 1
* **Độ khó:** Dễ
* **Câu hỏi:** Trước khi dẫn dắt xây dựng một giao diện web responsive cho người dùng cuối, bạn thường đánh giá những rủi ro kiến trúc nào?
...
### Câu 2
* **Độ khó:** Dễ
* **Câu hỏi:** Bạn mentor một teammate ít kinh nghiệm hơn đang làm về thiết kế component, quản lý state, accessibility, hiệu năng và tích hợp API như thế nào?
...
### Câu 3
* **Độ khó:** Dễ
* **Câu hỏi:** Dấu hiệu nào cho thấy một solution trong hệ HTML, CSS, JavaScript, TypeScript, React, Vite đang trở nên khó bảo trì?
...
### Câu 4
* **Độ khó:** Trung bình
* **Câu hỏi:** Hãy thiết kế high-level approach để scale một giao diện web responsive cho người dùng cuối khi usage tăng 10 lần.
...
### Câu 6
* **Độ khó:** Trung bình
* **Câu hỏi:** Bạn định nghĩa success metrics cho một dự án liên quan tới thiết kế component, quản lý state, accessibility, hiệu năng và tích hợp API như thế nào?
...
### Câu 7
* **Độ khó:** Trung bình
* **Câu hỏi:** Khi thiết kế một giao diện web responsive cho người dùng cuối, bạn tiếp cận security và privacy như thế nào?
...
### Câu 8
* **Độ khó:** Khó
* **Câu hỏi:** Hai senior engineer bất đồng hướng thiết kế cho một giao diện web responsive cho người dùng cuối. Bạn sẽ dẫn dắt việc ra quyết định thế nào?
...
### Câu 9
* **Độ khó:** Khó
* **Câu hỏi:** Bạn xử lý một legacy system liên quan tới thiết kế component, quản lý state, accessibility, hiệu năng và tích hợp API vừa business-critical vừa rủi ro khi sửa như thế nào?
...
### Câu 10
* **Độ khó:** Khó
* **Câu hỏi:** Bạn chuẩn bị một giao diện web responsive cho người dùng cuối để một team khác có thể ownership lâu dài như thế nào?

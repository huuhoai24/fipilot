...
### Câu 1
* **Độ khó:** Dễ
* **Câu hỏi:** Theo bạn, trách nhiệm chính của một AI Engineer trong team phần mềm là gì?
* **Đáp án mẫu:** Câu trả lời tốt nên nêu được việc hiểu yêu cầu được giao, đóng góp vào một ứng dụng có tích hợp AI, làm việc cẩn thận, báo sớm blocker, tuân thủ tiêu chuẩn của team và có tinh thần học hỏi.

### Câu 2
* **Độ khó:** Dễ
* **Câu hỏi:** Bạn đã từng dùng công cụ hoặc công nghệ nào trong nhóm sau: Python, embeddings, vector database, LangChain/LlamaIndex, FastAPI?
...
### Câu 3
* **Độ khó:** Dễ
* **Câu hỏi:** Trước khi bàn giao một ứng dụng có tích hợp AI, bạn kiểm tra công việc của mình như thế nào?
...
### Câu 4
* **Độ khó:** Trung bình
* **Câu hỏi:** Hãy kể một bug hoặc vấn đề bạn từng gặp khi làm việc với tích hợp LLM, RAG, prompt design, evaluation, model serving và safety. Bạn đã điều tra như thế nào?
...
### Câu 6
* **Độ khó:** Trung bình
* **Câu hỏi:** Trong công việc AI Engineer, khác nhau giữa cách vá tạm và cách sửa đúng gốc là gì?

# Bộ Câu Hỏi Phỏng Vấn Web Developer (Level 2)
...
### Câu 1
* **Độ khó:** Dễ
* **Câu hỏi:** Khi nhận một task Web Developer cỡ vừa, bạn chia nhỏ công việc trước khi implement như thế nào?
...
### Câu 2
* **Độ khó:** Dễ
* **Câu hỏi:** Với một tính năng website đáng tin cậy, bạn sẽ thêm những quality check nào trước khi đưa vào production?
...
### Câu 3
* **Độ khó:** Dễ
* **Câu hỏi:** Theo bạn phần nào trong nền tảng web, hành vi trình duyệt, responsive UI, form và gọi API dễ phát sinh lỗi nhất, và bạn giảm lỗi bằng cách nào?
...
### Câu 6
* **Độ khó:** Trung bình
* **Câu hỏi:** Bạn sẽ thiết kế error handling cho một tính năng website đáng tin cậy như thế nào?
...
### Câu 7
* **Độ khó:** Trung bình
* **Câu hỏi:** Khi review công việc của teammate liên quan tới nền tảng web, hành vi trình duyệt, responsive UI, form và gọi API, bạn tập trung vào điểm gì?
...
### Câu 8
* **Độ khó:** Khó
* **Câu hỏi:** Một sự cố production xuất hiện sau release liên quan tới một tính năng website đáng tin cậy. Bạn sẽ xử lý incident như thế nào?
...
### Câu 9
* **Độ khó:** Khó
* **Câu hỏi:** Bạn cân bằng tốc độ delivery và technical debt trong dự án dùng HTML, CSS, JavaScript, REST API, kiến thức SEO cơ bản như thế nào?

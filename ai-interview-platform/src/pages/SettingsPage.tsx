  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="font-display text-2xl font-bold tracking-tight-display text-text-primary">Cài đặt phỏng vấn</h1>
          <p className="mt-1 text-sm text-text-muted">Cấu hình các profile dùng để tạo phiên phỏng vấn.</p>
        </div>
        <Button variant="secondary">
          <Plus className="h-4 w-4" /> Cấu hình mới
        </Button>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[280px_1fr]">
        <Card>
          <div className="border-b border-border px-4 py-3">
            <h3 className="text-xs font-semibold uppercase tracking-wide text-text-muted">Cấu hình</h3>
          </div>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="flex justify-between border-t border-border pt-4">
              <Button variant="danger" size="sm">
                <Trash2 className="h-3.5 w-3.5" /> Xóa cấu hình
              </Button>
              <Button>
                <Save className="h-4 w-4" /> Lưu làm bộ câu hỏi
              </Button>
            </div>
          </CardContent>
        </Card>

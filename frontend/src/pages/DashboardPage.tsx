...
export function DashboardPage() {
  ...
  const statCards = [
    ...
    { label: 'Avg score this week', value: dashboardStats.avgScoreThisWeek.toFixed(1), icon: TrendingUp, accent: 'text-success' },
    { label: 'Active templates', value: dashboardStats.activeTemplates, icon: FileStack, accent: 'text-text-primary' },
    { label: 'Pending review', value: dashboardStats.pendingReview, icon: Clock3, accent: 'text-warning' },
  ]

...
export function VoiceStatusIndicator({ state, elapsedSeconds }: VoiceStatusIndicatorProps) {
  const content = {
    [VoiceInterviewState.IDLE]: {
      icon: Radio,
      title: 'Sẵn sàng',
      detail: 'Microphone sẽ tắt cho đến khi bạn bắt đầu trả lời.',
      color: 'text-text-muted',
    },
    [VoiceInterviewState.WAITING_FOR_USER]: {
      icon: Radio,
      title: 'Sẵn sàng cho câu trả lời',
      detail: 'Nhấn nút microphone khi bạn sẵn sàng nói.',
      color: 'text-accent',
    },
    [VoiceInterviewState.USER_SPEAKING]: {
      icon: Mic,
      title: 'Đang ghi âm câu trả lời',
      detail: `${formatElapsed(elapsedSeconds)} - có thể tạm dừng; nhấn Dừng khi hoàn tất.`,
      color: 'text-danger',
    },
    [VoiceInterviewState.EVALUATING]: {
      icon: Loader2,
      title: 'Đang đánh giá câu trả lời...',
      detail: 'Đang chuẩn bị quyết định tiếp theo.',
      color: 'text-warning',
    },
    [VoiceInterviewState.TRANSCRIBING]: {
      icon: Loader2,
      title: 'Đang hiểu câu trả lời của bạn...',
      detail: 'Nhận diện giọng nói đang hoàn tất bản ghi.',
      color: 'text-warning',
    },
    [VoiceInterviewState.AI_THINKING]: {
      icon: BrainCircuit,
      title: 'Nhà phỏng vấn AI đang suy nghĩ',
      detail: 'Đang chọn câu hỏi tiếp theo.',
      color: 'text-warning',
    },
    [VoiceInterviewState.AI_SPEAKING]: {
      icon: Volume2,
      title: 'Nhà phỏng vấn AI đang nói',
      detail: 'Hãy nói tự nhiên để ngắt và trả lời.',
      color: 'text-accent',
    },
    [VoiceInterviewState.INTERRUPTED]: {
      icon: Zap,
      title: 'Đã ngắt',
      detail: 'Chuyển sang câu trả lời của bạn.',
      color: 'text-warning',
    },
  }[state]
